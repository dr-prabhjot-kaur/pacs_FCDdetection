...
# unregistered inputs (T1 and FLAIR have different shapes).
...
MELD_TEMPLATE_SRC="/fileserver/Rad-Warfield-e2/Groups/Imp-Recons/prabhjot/work/gits/MELDgraph2026/meld_data/meld_params"
cp "$MELD_TEMPLATE_SRC" "$output_dir/" 2>/dev/null || {
    echo "Warning: Could not copy fsaverage_sym template files"
}
