...
#
# The processor receives input/ as a STUDY directory — multiple
# series for the same patient + study date. The processor is
# responsible for classifying modalities, validating completeness,
# and producing whatever output it produces.
#
...
# --- python environment (PATH-based, no conda activate) ---------------------
